/* 
 ...
 Proba RX-a sa serijskom komunikacijom  28.09.2016. - OK
 ...
 17.10.2016.  odradjeno u task scheduler-u
*/
...
void naVreme1() {           //   SLANJE PODATAKA NA 5 SEKUNDI
...
void naVreme2() {                // UPLODOVANJE  NA  1 MINUT
...
//****  Serijska komunikacija sa RF PRIJEMNIKA ********
  ...
  if (Serial2.available()) {    
    ...
    dtostrf(rxByte,2,0,rxByteCh);
    Serial.print("-");
    Serial.print(rxByteCh);
    Serial.println("-");
    client.publish("kuca/rfKod", rxByteCh);  // Prosledjuje primljeni KOD sa Arduino Nano na HAB !
